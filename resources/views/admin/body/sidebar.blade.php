    ...
    <div id="sidebar" class="sidebar sidebar-with-footer">
      ...
      <div class="sidebar-scrollbar">
        ...
        <ul class="nav sidebar-inner" id="sidebar-menu">
            ...
            <li  class="active" >
            <a class="sidenav-item-link" href="{{url('home/slider')}}">
            ...
            <li  class="active" >
                <a class="sidenav-item-link" href="{{url('home/about')}}">
                    <span class="nav-text">Home About </span>

                </a>
                </li>
                <li  class="active" >
                    <a class="sidenav-item-link" href="{{url('home/service')}}">
                        <span class="nav-text">Services</span>   </a>
                    </li>

                <li  class="active" >
                    <a class="sidenav-item-link" href="{{url('multi/img')}}">
                ...
                <li  class="active" >
                    <a class="sidenav-item-link" href="{{url('all/brand')}}">
            ...
            <li  class="has-sub" >
              ...
              <ul  class="collapse"  id="ui-elements"
                ...
                <div class="sub-menu">
                    ...
                    <li  class="active" >
                        <a class="sidenav-item-link" href="{{url('admin/message')}}">
